...
tools: mkfs.cryexts cryextsck cryexts_journal_inject cryexts_journal_v2_inject cryexts_journal_v3_inject cryexts_journal_v3_ring_inject cryexts_orphan_inject cryexts_extent_inspect cryexts_dir_index_inspect cryexts_policy_inspect cryexts_journal_inspect cryexts_alloc_inspect cryexts_xattr_inspect cryexts_gdt_inspect
...
cryexts_journal_v3_ring_inject: tools/cryexts_journal_v3_ring_inject.c cryexts_fs.h
	$(CC) -Wall -Wextra -O2 -I. -o $@ tools/cryexts_journal_v3_ring_inject.c
...
clean:
	...
	$(RM) mkfs.cryexts cryextsck cryexts_journal_inject cryexts_journal_v2_inject cryexts_journal_v3_inject cryexts_journal_v3_ring_inject cryexts_orphan_inject cryexts_extent_inspect cryexts_dir_index_inspect cryexts_policy_inspect cryexts_journal_inspect cryexts_alloc_inspect cryexts_xattr_inspect cryexts_gdt_inspect cryexts.img
